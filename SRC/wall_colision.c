...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/07 14:05:32 by lkavalia          #+#    #+#             */
/*   Updated: 2023/05/07 16:23:28 by lkavalia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

int	wall_colision_a(t_hive *h, int check_wall_colision)
{
	int	corner1;
	int	corner2;
	int	center1;
...
int	wall_colision_s(t_hive *h, int check_wall_colision)
{
	int	corner1;
	int	corner2;
	int	center1;
...
int	wall_colision_w(t_hive *h, int check_wall_colision)
{
	int	corner1;
	int	corner2;
	int	center1;
...
int	wall_colision_d(t_hive *h, int check_wall_colision)
{
	int	corner1;
	int	corner2;
	int	center1;
